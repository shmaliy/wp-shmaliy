...
?>
	...
	<?php elseif ( !is_singular() && $nav = get_posts_nav_link( array( 'sep' => '', 'prelabel' => '<span class="previous">' . __( '&larr; Туда', 'hatch' ) . '</span>', 'nxtlabel' => '<span class="next">' . __( 'Сюда &rarr;', 'hatch' ) . '</span>' ) ) ) : ?>
